 ...
 * @author vjiucl
 */
public class ConsultarSaldoDolares extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            out.println("<!DOCTYPE html>"
                ...
                + "</head>"
                + "<body>"
                + "<h1><br/>" + controlador.consultarSaldoDolares(numCuenta, IniciarWeb.banco) + "</h1>"
                + "<a href=\"MenuPrincipal.html\"><button>Volver al menú principal</button></a>"
                + "</body>"
                + "</html>");
            
            controlador.crearRegistro(TipoAccion.ConsultarSaldoDolares, TipoVista.WEB, IniciarWeb.bitacora);
        }
